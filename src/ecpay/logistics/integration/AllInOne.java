...
public class AllInOne extends AllInOneBase{
	...
	public String genCheckMacValue(Hashtable<String, String> params){
		return EcpayFunction.genCheckMacValue(HashKey, HashIV, params);
	}
	...
	public String create(Object obj){
		...
		try{
			...
			if(isFormPost){
				...
				System.out.println("Create post String: "+httpValue);
