...
import com.matt.util.CalendarUtil;
...
//		obj.setServerReplyURL("http://114.35.76.164:8080/shoppingAgent/ecpay/afterCreate.do");
	...
	public static String postCreateCVS(){
		...
		obj.setMerchantTradeDate(CalendarUtil.getCurrentDatetime());
		obj.setLogisticsSubType("FAMIC2C");
		obj.setGoodsAmount("19000");
		obj.setSenderName("Yang");
...
//		obj.setServerReplyURL("http://114.35.76.164:8080/shoppingAgent/ecpay/afterCreate.do");
	...
	public static String postQueryLogisticsTradeInfo(){
		...
		obj.setAllPayLogisticsID("126047");
